                        ...
                        ZStack(alignment:.topLeading) {
                            ...
                            VStack(alignment: .leading) {
                                ...
                                ZStack {
                                    ...
                                    .padding(.bottom,8)
                                    LinearGradient(
                                        colors: [Color.white, Color.white.opacity(0),Color.white.opacity(0),Color.white.opacity(0)], startPoint: .leading, endPoint: .center
                                    ).frame(height: width * 0.28)
                                        .allowsHitTesting(false)
                                    LinearGradient(
                                        colors: [Color.white, Color.white.opacity(0),Color.white.opacity(0),Color.white.opacity(0)], startPoint: .trailing, endPoint: .center
                                    ).frame(height: width * 0.28)
                                        .allowsHitTesting(false)
                                }
                                HStack {
