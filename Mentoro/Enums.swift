...
enum SubCategory: String, CaseIterable, Identifiable, Codable {
    ...
    // 음식
    case 치킨, 피자, 떡볶이, 마라탕, 햄버거, 라면, 돈까스, 회, 초밥, 만두, 국밥, 국수, 빵, 과자, 아이스크림, 떡, 디저트, 커피, 차, 맥주, 소주, 와인, 위스키, 보드카, 고량주, 맛집탐방, 요리, 자취요리, 미식회, 맛난음식나누기, 레시피연구, 푸드페어, 푸드테크, 편의점, 노포맛집, 채식비건, 키토음식, 저탄고지
